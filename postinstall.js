// Thanks to the owner of this blog post, UTKARSH AGARWAL, for giving insights on how to properly set up the commands 
// needed to make the binary file callable as a command upon global installation of the npm package written in Golang.
